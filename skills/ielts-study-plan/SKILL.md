...
| `ielts_assets_search`、`ielts_resources_related`、`ielts_prep_search_guides`、`ielts_prep_read_guide`、`ielts_prediction_search_hits` | 用户资产、备考内容、预测及关联资源 | 仅使用服务端返回的记录、`contentRef` 和链接。 |
